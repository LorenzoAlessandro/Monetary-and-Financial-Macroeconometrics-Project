...
sname = 'Figure_3a';
VARvnames_long = {'One-Year Rate';'CPI';'Unemployment';'Exchange Rate';'Corporate Spread';'Mortgage Spread';'BAA Corporate Spread - US'; 'GDP';};
VARvnames      = {'i_1YR';'CPI';'unempl';'fxbis';'corp_spread';'mortg_spread';'us_baa';'gdp';};
